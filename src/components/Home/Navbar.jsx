  ...
  return (
    <Navbar fluid rounded className='bg-[#f5f5f5] '>
       <Navbar.Brand href="http">
         ...
         <span className=' ml-9 sm:ml-0 md:ml-0 px-2 py-1 lg:ml-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white'> Shree Computer Shop</span> 
       </Navbar.Brand>
    ...
    <Navbar.Collapse>
      ...
      <Navbar.Link className='md:hidden' href="#">Rental</Navbar.Link>
    </Navbar.Collapse>
  </Navbar>
  )
}
