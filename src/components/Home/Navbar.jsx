  ...
  return (
    <Navbar fluid rounded className='bg-[#f5f5f5] sticky top-0 z-10 ; '>
       <Navbar.Brand href="http">
         ...
         <Link to='/' className='font-bold ml-9 sm:ml-0 md:ml-0 px-2 py-1 lg:ml-16 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white'> Shree Computer Shop</Link> 
       </Navbar.Brand>
      <div className="flex md:order-2">
         <Link to='/contact' gradientDuoTone='purpleToBlue' className='outline mr-14 hidden md:inline'>Rental Services</Link>
      <Navbar.Toggle />
    </div>
    <Navbar.Collapse>
